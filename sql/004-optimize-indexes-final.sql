-- =====================================================
-- Database Optimization: Indexes & Constraints (FINAL)
-- =====================================================
...
-- NOTE: check_registration_dates constraint is intentionally NOT included
-- Reason: Historical Bolagsverket data contains some records where
-- avregistreringsdatum < registreringsdatum. This is valid historical data
