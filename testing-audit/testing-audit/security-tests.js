 ...
 */
function testOrgNumberValidation() {
 ...
 */
function testSearchQueryLimits() {
 ...
 */
function testErrorInformationLeakage() {
...
async function runSecurityTests() {
    ...
    await fs.writeFile(new URL('../testing-audit/security-test-results.json', import.meta.url), JSON.stringify(report, null, 2));
